...
// node_modules/.pnpm/i18n-iso-countries@7.14.0/node_modules/i18n-iso-countries/codes.json
var require_codes = __commonJS({
  "node_modules/.pnpm/i18n-iso-countries@7.14.0/node_modules/i18n-iso-countries/codes.json"(exports, module) {
    module.exports = [
...
// node_modules/.pnpm/i18n-iso-countries@7.14.0/node_modules/i18n-iso-countries/supportedLocales.json
var require_supportedLocales = __commonJS({
  "node_modules/.pnpm/i18n-iso-countries@7.14.0/node_modules/i18n-iso-countries/supportedLocales.json"(exports, module) {
    module.exports = [
      "br",
      "cy",
      "dv",
...
// node_modules/.pnpm/i18n-iso-countries@7.14.0/node_modules/i18n-iso-countries/index.js
var require_i18n_iso_countries = __commonJS({
  "node_modules/.pnpm/i18n-iso-countries@7.14.0/node_modules/i18n-iso-countries/index.js"(exports) {
    "use strict";
      ...
      try {
        ...
        for (const p in codenames) {
          ...
          if (typeof codenames[p] === "string") {
            if (areSimilar(codenames[p], name2)) {
              return p;
            }
          }
...
var import_i18n_iso_countries = __toESM(require_i18n_iso_countries(), 1);

// node_modules/.pnpm/i18n-iso-countries@7.14.0/node_modules/i18n-iso-countries/langs/zh.json
var zh_default = {
  locale: "zh",
  countries: {
    AD: "\u5B89\u9053\u5C14",
...
function addProxies(config2, airportNodeList2) {
  if (config2["proxy-providers"] !== void 0) {
    delete config2["proxy-providers"];
  }
