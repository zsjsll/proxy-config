...
i18nIsoCountriesExports.registerLocale(zhLocale);
let name = "all";
...
function addProxies(config, airportNodeList) {
...
function getCountryList(list) {
    let coutnryList = list.map((v)=>{
        ...
        return country === undefined ? "其他" : i18nIsoCountriesExports.getName(country, "zh");
    });
    coutnryList = [
        ...new Set(coutnryList)
    ];
...
function changeProxyGroups(config, airportNodeList) {
