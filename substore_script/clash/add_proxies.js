...
function p(e){if(typeof e=="boolean")return e;if(e==="true")return!0;if(e==="false")return!1;throw new Error(`\u4F20\u5165\u53C2\u6570\u9519\u8BEF\uFF0C${e}\u5E94\u8BE5\u4E3Aboolen`)}function l(e){return typeof e!="string"?e:e.split(/[|, ]/)}var{name:f="airport",fixEmoji:i=!1,type:y="subscription",urls:t=[""]}=$arguments;t=l(t);i=p(i);var a=await produceArtifact({name:f,type:y,platform:"ClashMeta",produceType:"internal",produceOpts:{"include-unsupported-proxy":!0}}),r=ProxyUtils.yaml.safeLoad($files[0]),c={url:"https://a.a.a/",type:"http",interval:43200,"health-check":{enable:!0,url:"https://www.gstatic.com/generate_204",interval:180},proxy:"DIRECT"};i&&a.map(e=>{e.name=e.name.replace("\u{1F3F4}\u200D\u2620\uFE0F","\u2753")});if(t.length>0){if(r["proxy-providers"])throw new Error("\u8BF7\u5148\u5220\u9664 proxy-providers");let e=t.reduce((o,s,u)=>{let n="airport"+u;return o[n]=c,o[n].url=s,o},{});r["proxy-providers"]=e}else r={proxies:a,...r};$content=ProxyUtils.yaml.safeDump(r);
